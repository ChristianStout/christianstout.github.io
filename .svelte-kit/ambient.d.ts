...
declare module '$env/static/private' {
	...
	export const npm_package_devDependencies__importantimport_eslint_config: string;
	...
	export const npm_package_devDependencies__unocss_eslint_plugin: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_devDependencies__importantimport_eslint_config: string;
		...
		XDG_VTNR: string;
		ZSH_CUSTOM: string;
		npm_package_devDependencies__unocss_eslint_plugin: string;
